Shader "Custom/NewImageEffectShader"
{
	...
	// Scrolls texture to the right
		...
		_ScrollSpeedU("ScrollSpeedU", Range(0.0,5.0)) = 1
		_ScrollSpeedV("ScrollSpeedV", Range(0.0,5.0)) = 1
	
	// Scrolls Texture to the left
		_ScrollTexture1("ScrollTexture1" , 2D) = "white" {}
		_ScrollSpeedU1("ScrollSpeedU1", Range(0.0,5.0)) = 1
		_ScrollSpeedV1("ScrollSpeedV1", Range(0.0,5.0)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			return MainColour + ScrollColour + ScrollColour1;
			}
			ENDCG
		}
	}
